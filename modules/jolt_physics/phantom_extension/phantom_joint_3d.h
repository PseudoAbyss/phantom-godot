...
class PhantomJoint3D : public Node3D {
	GDCLASS(PhantomJoint3D, Node3D)
...
public:
	...
	int32_t get_solver_priority() const { return solver_priority; }

	void set_solver_priority(int32_t p_solver_priority);

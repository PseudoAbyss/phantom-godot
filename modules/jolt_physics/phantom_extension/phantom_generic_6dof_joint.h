...
class PhantomGeneric6DOFJoint3D final : public PhantomJoint3D {
	GDCLASS(PhantomGeneric6DOFJoint3D, PhantomJoint3D)
...
public:
	...
	enum Param {
		...
		PARAM_LINEAR_SPRING_STIFFNESS = JoltPhysicsServer3D::G6DOF_JOINT_LINEAR_SPRING_STIFFNESS,
		...
		PARAM_ANGULAR_SPRING_STIFFNESS = JoltPhysicsServer3D::G6DOF_JOINT_ANGULAR_SPRING_STIFFNESS,
...
public:
	...
	double get_linear_spring_x_stiffness() const { return get_param_x(PARAM_LINEAR_SPRING_STIFFNESS); }

	void set_linear_spring_x_stiffness(double p_value) { set_param_x(PARAM_LINEAR_SPRING_STIFFNESS, p_value); }
	...
	double get_linear_spring_y_stiffness() const { return get_param_y(PARAM_LINEAR_SPRING_STIFFNESS); }

	void set_linear_spring_y_stiffness(double p_value) { set_param_y(PARAM_LINEAR_SPRING_STIFFNESS, p_value); }
	...
	double get_linear_spring_z_stiffness() const { return get_param_z(PARAM_LINEAR_SPRING_STIFFNESS); }

	void set_linear_spring_z_stiffness(double p_value) { set_param_z(PARAM_LINEAR_SPRING_STIFFNESS, p_value); }
	...
	bool get_linear_spring_frequency_x_enabled() const { return get_flag_x(FLAG_ENABLE_LINEAR_SPRING_FREQUENCY); }

	void set_linear_spring_frequency_x_enabled(bool p_enabled) { set_flag_x(FLAG_ENABLE_LINEAR_SPRING_FREQUENCY, p_enabled); }

	bool get_linear_spring_frequency_y_enabled() const { return get_flag_y(FLAG_ENABLE_LINEAR_SPRING_FREQUENCY); }

	void set_linear_spring_frequency_y_enabled(bool p_enabled) { set_flag_y(FLAG_ENABLE_LINEAR_SPRING_FREQUENCY, p_enabled); }

	bool get_linear_spring_frequency_z_enabled() const { return get_flag_z(FLAG_ENABLE_LINEAR_SPRING_FREQUENCY); }

	void set_linear_spring_frequency_z_enabled(bool p_enabled) { set_flag_z(FLAG_ENABLE_LINEAR_SPRING_FREQUENCY, p_enabled); }
	...
	double get_angular_spring_x_stiffness() const { return get_param_x(PARAM_ANGULAR_SPRING_STIFFNESS); }

	void set_angular_spring_x_stiffness(double p_value) { set_param_x(PARAM_ANGULAR_SPRING_STIFFNESS, p_value); }
	...
	double get_angular_spring_y_stiffness() const { return get_param_y(PARAM_ANGULAR_SPRING_STIFFNESS); }

	void set_angular_spring_y_stiffness(double p_value) { set_param_y(PARAM_ANGULAR_SPRING_STIFFNESS, p_value); }
	...
	double get_angular_spring_z_stiffness() const { return get_param_z(PARAM_ANGULAR_SPRING_STIFFNESS); }

	void set_angular_spring_z_stiffness(double p_value) { set_param_z(PARAM_ANGULAR_SPRING_STIFFNESS, p_value); }
	...
	bool get_angular_spring_x_frequency_enabled() const { return get_flag_x(FLAG_ENABLE_ANGULAR_SPRING_FREQUENCY); }

	void set_angular_spring_x_frequency_enabled(bool p_enabled) { set_flag_x(FLAG_ENABLE_ANGULAR_SPRING_FREQUENCY, p_enabled); }

	bool get_angular_spring_y_frequency_enabled() const { return get_flag_y(FLAG_ENABLE_ANGULAR_SPRING_FREQUENCY); }

	void set_angular_spring_y_frequency_enabled(bool p_enabled) { set_flag_y(FLAG_ENABLE_ANGULAR_SPRING_FREQUENCY, p_enabled); }

	bool get_angular_spring_z_frequency_enabled() const { return get_flag_z(FLAG_ENABLE_ANGULAR_SPRING_FREQUENCY); }

	void set_angular_spring_z_frequency_enabled(bool p_enabled) { set_flag_z(FLAG_ENABLE_ANGULAR_SPRING_FREQUENCY, p_enabled); }
...
private:
	...
	double linear_spring_stiffness[AXIS_COUNT] = {};
	...
	double angular_spring_stiffness[AXIS_COUNT] = {};
	...
	bool linear_spring_frequency_enabled[AXIS_COUNT] = {};
	...
	bool angular_spring_frequency_enabled[AXIS_COUNT] = {};
};

VARIANT_ENUM_CAST(PhantomGeneric6DOFJoint3D::Param)
VARIANT_ENUM_CAST(PhantomGeneric6DOFJoint3D::Flag)
